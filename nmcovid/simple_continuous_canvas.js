...
var Simple_Continuous_Module = function(canvas_width, canvas_height) {
	...
	canvas_tag += "style='background-image: url(\"/local/nmcounties.gif\"); background-repeat: no-repeat; background-position: center; background-size: 1000px 1000px; border: 1px dotted'></canvas>";
	// Append it to body:
